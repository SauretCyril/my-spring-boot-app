...
/**
 * RagRestController est un contrôleur REST Spring Boot qui gère les
 * interactions avec un service de chat IA.
 * Il fournit plusieurs endpoints pour poser des questions à l'IA et recevoir
 * des réponses basées soit sur un contenu prédéfini,
 * soit sur des informations contextuelles récupérées à partir d'un vector
 * store.
 */
@RestController
public class RagRestController {
     ...
     * @param vectorStore       Le VectorStore utilisé pour rechercher des documents
     ...
     * Utilise la question fournie pour rechercher des documents similaires dans le
     * vector store, crée un prompt
     * basé sur les résultats de la recherche et la question, et retourne la réponse
     * de l'IA au format Markdown.
     *
    ...
    public String ask(String question) {
        ...
        // Recherche de documents similaires dans le vector store en fonction de la
        // question posée
    ...
    public String ask1(String question) {
        ...
        String myContent = """
                ...
                """;
        // Création du prompt en remplaçant les variables "content" et "input" dans le
        // modèle de prompt
     ...
     * Retourne une liste de réponses générées par l'IA en fonction de la question
     * posée.
     *
     * @param question La question posée par l'utilisateur.
