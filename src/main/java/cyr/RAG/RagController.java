...
/**
 * RagController est un contrôleur Spring MVC qui gère les interactions de
 * l'utilisateur via une interface web.
 * Il permet de poser des questions à un service d'IA et d'afficher les
 * réponses.
 */
@Controller
public class RagController {
     ...
     *
     * @param ragRestController Instance de RagRestController utilisée pour
     *                          interagir avec le service d'IA.
     */
    @Autowired
    ...
    /**
     * Récupère la liste des fichiers JSON présents dans le répertoire
     * "src/main/resources/vectorestore".
     *
    ...
    private List<String> getJsonFiles() throws Exception {
        ...
        if (!Files.exists(startPath)) {
            ...
            return jsonResources; // Retourne une liste vide car le répertoire vient d'être créé
        }
     ...
     * <p>
     * Envoie la question posée par l'utilisateur au service d'IA et affiche la
     * réponse dans la vue.
     *
     * @param question La question posée par l'utilisateur.
     * @param model    Le modèle utilisé pour ajouter des attributs à la vue.
     * @return Le nom de la vue "chatRag" avec la réponse de l'IA.
     * @throws Exception En cas de problème d'accès aux fichiers JSON ou lors de
