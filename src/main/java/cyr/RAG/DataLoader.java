...
/**
 * DataLoader est une classe de composant Spring qui gère le chargement de
 * fichiers PDF,
...
public class DataLoader {
    ...
    // Modèle d'embedding utilisé pour générer les vecteurs à partir du contenu des
    // documents
    @Autowired
    private EmbeddingModel embeddingModel;

    /**
     * Crée un bean SimpleVectorStore qui charge ou génère des vecteurs d'embedding
    ...
    public SimpleVectorStore simpleVectorStore() throws Exception {
        ...
        try {
            ...
            for (Resource pdfFile : pdfFiles) {
                ...
                String path = Path.of("src", "main", "resources", "vectorestore").toFile().getAbsolutePath() + "/"
                        + vectorStoreName;
                ...
                try {
                    ...
                    // Sinon, le contenu du PDF est lu, découpé en chunks, et des vecteurs sont
                    // générés
                    else {
    ...
    /**
     * Récupère la liste des fichiers PDF présents dans le répertoire de ressources
     * spécifié.
     *
